...
### Hint
<span class="spoiler">It is not possible for all $n$. There is exactly one $n  \leq 6$ with no solutions. Can you find which one, and prove that it has no solutions?</span>
